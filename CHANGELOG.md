...
- Added Minecraft 26.3 support for Fabric and NeoForge.
- Updated dependencies, metadata and Gradle to 9.6.0.
- Preserved all three gamerules and the existing drop behavior.
