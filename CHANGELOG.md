...
- Added the NeoForge port, built against NeoForge 21.0.167 for the 1.21.x series
...
- Fixed NeoForge 1.21.11 startup by deferring registration for the modern gamerule registry while retaining the legacy 1.21.x path
- Fixed legacy enum gamerule extraction on NeoForge 1.21 through 1.21.10 when an entity dies
